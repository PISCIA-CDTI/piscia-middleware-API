...
export class ElectricityMeter extends CorePlugin {
    ...
    async connectHardware() {
        ...
        const consumptionInformation = [
            {
                data: 110650,
                timestamp: "2018-02-01 hh:mm:ss.SSS"
            },
            {
                data: 106504,
                timestamp: "2018-03-01 hh:mm:ss.SSS"
            },
            {
                data: 14403,
                timestamp: "2018-04-01 hh:mm:ss.SSS"
            },
            {
                data: 45006,
                timestamp: "2018-05-01 hh:mm:ss.SSS"
            },
            {
                data: 117794,
                timestamp: "2018-06-01 hh:mm:ss.SSS"
            },
            {
                data: 156006,
                timestamp: "2018-07-01 hh:mm:ss.SSS"
            },
            {
                data: 181366,
                timestamp: "2018-08-01 hh:mm:ss.SSS"
            },
            {
                data: 200500,
                timestamp: "2018-09-01 hh:mm:ss.SSS"
            },
            {
                data: 151462,
                timestamp: "2018-10-01 hh:mm:ss.SSS"
            },
            {
                data: 53412,
                timestamp: "2018-11-01 hh:mm:ss.SSS"
            },
            {
                data: 6463,
                timestamp: "2018-12-01 hh:mm:ss.SSS"
            },
            {
                data: 1828,
                timestamp: "2019-01-01 hh:mm:ss.SSS"
            },
            {
                data: 2964,
                timestamp: "2019-02-01 hh:mm:ss.SSS"
            },
            {
                data: 1136,
                timestamp: "2019-03-01 hh:mm:ss.SSS"
            },
            {
                data: 47663,
                timestamp: "2019-04-01 hh:mm:ss.SSS"
            }
        ]
